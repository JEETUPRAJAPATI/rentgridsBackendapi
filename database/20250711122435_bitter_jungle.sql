...
-- Clear existing data
TRUNCATE TABLE property_amenities, property_features, property_documents, property_images, property_location, properties, property_categories, amenities, admin_password_resets, permission_admin, permission_role, role_admin, permissions, roles, user_logins, admins, users RESTART IDENTITY CASCADE;
...
INSERT INTO property_location (property_id, country, state, city, locality, landmark, zipcode, full_address) VALUES
(1, 'India', 'Maharashtra', 'Mumbai', 'Bandra West', 'Near Bandra Station', '400050', 'A-1204, Sunrise Towers, Linking Road, Bandra West, Mumbai - 400050'),
(2, 'India', 'Karnataka', 'Bangalore', 'Koramangala', 'Near Forum Mall', '560034', 'Villa No. 45, 5th Block, Koramangala, Bangalore - 560034'),
(3, 'India', 'Delhi', 'Delhi', 'Connaught Place', 'Near Metro Station', '110001', 'Office No. 301, Connaught Plaza, Connaught Place, New Delhi - 110001'),
(4, 'India', 'Maharashtra', 'Pune', 'Kothrud', 'Near Kothrud Depot', '411038', 'Flat No. 402, Shanti Apartments, Kothrud, Pune - 411038'),
(5, 'India', 'Tamil Nadu', 'Chennai', 'Anna Nagar', 'Near Anna Nagar Tower', '600040', 'No. 25, 2nd Avenue, Anna Nagar West, Chennai - 600040'),
(6, 'India', 'Maharashtra', 'Mumbai', 'Andheri East', 'Near Metro Station', '400069', 'Shop No. 15, Metro Plaza, Andheri East, Mumbai - 400069');

-- Insert property features
INSERT INTO property_features (property_id, feature_key, feature_value) VALUES
-- Property 1 features
(1, 'Sea View', 'Partial sea view from balcony'),
(1, 'Parking', '1 covered parking space'),
(1, 'Floor', '12th floor with elevator'),
(1, 'Age', '5 years old building'),

-- Property 2 features
(2, 'Garden', 'Private garden with landscaping'),
(2, 'Parking', '2 car parking spaces'),
(2, 'Solar', 'Solar water heating system'),
(2, 'Age', 'Newly constructed'),

-- Property 3 features
(3, 'Location', 'Prime commercial location'),
(3, 'Parking', 'Dedicated parking spaces'),
(3, 'Connectivity', 'Metro connectivity'),
(3, 'Facilities', 'Conference rooms available'),

-- Property 4 features
(4, 'Furnished', 'Fully furnished with appliances'),
(4, 'Parking', 'Two-wheeler parking'),
(4, 'Connectivity', 'Near IT hubs'),
(4, 'Age', '3 years old building'),

-- Property 5 features
(5, 'Terrace', 'Large terrace with garden'),
(5, 'Parking', '2 car parking + 2 two-wheeler'),
(5, 'Kitchen', 'Modular kitchen with chimney'),
(5, 'Age', '8 years old house'),

-- Property 6 features
(6, 'Location', 'High footfall commercial area'),
(6, 'Visibility', 'Good road visibility'),
(6, 'Connectivity', 'Metro and bus connectivity'),
(6, 'Facilities', 'Common washroom facilities');
